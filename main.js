...
conn.welcome = ''
conn.bye = ''
conn.spromote = '*𝑨𝑳𝑬𝑹𝑻𝑨:* 𝑫𝒆𝒕𝒆𝒄𝒕𝒂𝒎𝒐𝒔 𝒖𝒏 𝒏𝒖𝒆𝒗𝒐 𝒂𝒅𝒎𝒊𝒏.'
conn.sdemote = '*𝑨𝑳𝑬𝑹𝑻𝑨:* 𝑫𝒆𝒕𝒆𝒄𝒕𝒂𝒎𝒐𝒔 -1 𝒂𝒅𝒎𝒊𝒏.'
conn.sDesc = ''
conn.sSubject = ''
conn.sIcon = ''
conn.sRevoke = ''
...
setInterval(async () => {
  ...
  const bio = `🚀 𝑪𝑶𝑴𝑼𝑵𝑰𝑫𝑨𝑫 𝑭𝑰𝑭𝑻𝒀 𝑪𝑬𝑵𝑻𝑺 𝑩𝒐𝒕 𝑨𝒄𝒕𝒊𝒗𝒐 | 𝑪𝒓𝒆𝒂𝒅𝒐𝒓 +51 936732723 ${uptime}`;
